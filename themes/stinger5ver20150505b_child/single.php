...
?>
          ...
          <div class="blogbox"><p class="tagst"><i class="fa fa-tags"></i>&nbsp;-
            <?php the_category(', ') ?>
            <?php the_tags('', ', '); ?>
          </p>
<!--
          ...
          <?php if ( wp_is_mobile() ) : ?>
          <?php get_template_part('mobile_ad'); ?>  
          <?php else: ?>
          <!--PC用コンテンツ-->
          <?php endif; ?>
          <?php the_content(); //本文 ?>
          <?php if(has_tag('ハリアー')): ?>
　　　　　　　　　　　　　　　　　　　　　<?php get_template_part('killer_harrier'); ?>
　　　　　　　　　　　　　　　　　　　　　<?php else: ?>
　　　　　　　　　　　　　　　　　　　　<?php get_template_part('killer'); ?>
　　　　　　　　　　　　　　　　　　　　<?php endif; ?>
             <?php if ( wp_is_mobile() ) : ?>
            <?php get_template_part('mobile_ad2'); ?>
            <?php else: ?>
            <!--PC用コンテンツ-->
           <?php endif; ?>
            <?php endwhile; else: ?>
...
<!--
          <p class="tagst"><i class="fa fa-tags"></i>&nbsp;-
            <?php the_category(', ') ?>
            <?php the_tags('', ', '); ?>
          </p>--><aside><div style="padding:20px 0px;">
